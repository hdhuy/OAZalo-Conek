...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //}
        return true;
        //return false; --t set == true de online
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseKey = "51VJ3KT1W3S2FW996VXFNNLKF8B8LTYH";

        string idGet = "one-edu";
        if (HttpContext.Current.Session["TRUONG"] != null)
        {
            OneEduDataAccess.Model.TRUONG x = (OneEduDataAccess.Model.TRUONG)HttpContext.Current.Session["TRUONG"];
            idGet = x.MA;
        }
        

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "~/uploads/school/"+idGet+"/";
        //BaseUrl = "http://localhost/Conekweb/uploads/";
